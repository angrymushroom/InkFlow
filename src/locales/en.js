export default {
  ...
  ai: {
    ...
    setupText: 'Add your API key in Export → AI. You can use Google Gemini (free key) or OpenAI. Your key is stored only in this browser.',
    goToSetup: 'Go to Setup',
    close: 'Close',
    checkKey: 'Check key or Test API in Export → AI',
