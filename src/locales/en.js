export default {
  ...
  pip: {
    ...
    coachQuestion: {
      ...
      save_the_cat: {
        logline: 'Give me your one-sentence pitch \u2014 who is the hero, what do they want, and what stands in their way?',
        catalyst: 'What is the inciting event that forces your hero to leave their ordinary world and enter Act Two?',
        debate: "What does your hero do with their new situation? What's the fun, exciting, or challenging part of this new world?",
        midpoint: 'What happens at the halfway point that raises the stakes and pushes your hero from reactive to proactive?',
        allIsLost: 'What is the darkest moment \u2014 when everything your hero has worked for seems destroyed?',
        finale: 'How does your hero dig deep and win the day? What have they truly learned or become?',
      },
      story_circle: {
        you: 'Who is your protagonist, and what is their comfortable, stable world at the start?',
        need: 'What does your protagonist need, consciously or unconsciously, that their current life cannot provide?',
        go: 'What pushes or pulls your protagonist out of their comfort zone and into the unknown?',
        search: 'What does your protagonist do to try to get what they need in this unfamiliar situation?',
        find: 'What does your protagonist find or achieve \u2014 the thing they were searching for?',
        take: 'What price must your protagonist pay to keep what they found? What is taken from them?',
        return: 'How does your protagonist return to their familiar world, changed by the experience?',
  ...
  novelImport: {
    buttonLabel: 'Import from Novel Text ✨',
    modalTitle: 'Import Novel',
    step1Title: 'Upload your novel file',
    step2Title: 'Review detected structure',
    step3Title: 'Confirm import',
    uploadLabel: 'Choose a file (.txt or .md)',
    fileLoaded: 'File loaded — ready to analyze',
    uploadHint: 'Supports .txt and .md files',
    uploadHintWithEpub: 'Supports .txt, .md and .epub files',
    epubInvalid: 'This EPUB file appears to be invalid or DRM-protected.',
    epubEmpty: 'No readable text found in this EPUB file.',
    charsLoaded: 'characters loaded',
    analyzeBtn: 'Analyze',
    analyzing: 'Analyzing…',
    backBtn: 'Back',
    importBtn: 'Import into story',
    importing: 'Importing…',
    cancelBtn: 'Cancel',
    chaptersFound: '{count} chapters detected',
    oneChapterFound: '1 chapter detected',
    scenesFound: '{count} scenes',
    charactersFound: '{count} characters detected',
    noCharacters: 'No characters detected',
    detectedTemplate: 'Detected structure: {name}',
    templateConfidence: 'Confidence: {pct}%',
    lowConfidenceWarning: 'Structure confidence is low — please review before importing.',
    spinePreviewTitle: 'Story spine preview',
    emptySpine: '(Not detected)',
    confirmTitle: 'This will replace the current outline, characters, and story spine.',
    confirmHint: 'Your existing scenes and characters will be removed. This cannot be undone.',
    successToast: 'Novel imported successfully!',
    errorNoText: 'Please upload a file first.',
    errorTooShort: 'Text is too short to analyze (minimum 200 characters).',
