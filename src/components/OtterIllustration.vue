  ...
  <div class="otter-wrap" :class="`otter--${size}`">
    ...
    >
      ...
      <template v-if="variant !== 'writing'">
        ...
        <rect x="59" y="100" width="19" height="25" rx="2" class="prop" style="opacity:.38" />
        <!-- spine -->
        ...
        <line x1="62" y1="108" x2="74" y2="108" class="page-line" style="opacity:.28" />
        <line x1="62" y1="113" x2="74" y2="113" class="page-line" style="opacity:.28" />
      </template>
      ...
      <template v-if="variant === 'writing'">
        ...
        <!-- pen barrel -->
        <rect x="88" y="78" width="5" height="30" rx="2.5" class="prop" transform="rotate(30 90 93)" />
        <!-- pen tip -->
...
.otter-svg { overflow: visible; display: block; }

.otter--sm .otter-svg { width: 72px;  height: auto; }
.otter--md .otter-svg { width: 112px; height: auto; }
.otter--lg .otter-svg { width: 152px; height: auto; }
...
.nose    { opacity: .65; }
.shine   { fill: #ffffff; }
.mouth   { stroke: #20103a; stroke-width: 2.2; stroke-linecap: round; fill: none; }
.whisker { stroke: #20103a; stroke-width: 1.2; stroke-linecap: round; opacity: .28; }
.prop         { fill: var(--accent); opacity: .55; }
.prop-detail  { stroke: var(--accent); stroke-width: 1.5; opacity: .5; }
.page-line    { stroke: #ffffff; stroke-width: 1.4; opacity: .7; }
.wline        { stroke: var(--accent); stroke-width: 2.5; stroke-linecap: round; opacity: .7; }

/* ── Colors: dark mode ── */
:global([data-theme="dark"]) .fur     { fill: #6e5f90; }
:global([data-theme="dark"]) .belly   { fill: #9e8fbe; }
:global([data-theme="dark"]) .feature { fill: #ede6ff; }
:global([data-theme="dark"]) .mouth   { stroke: #ede6ff; }
:global([data-theme="dark"]) .whisker { stroke: #ede6ff; opacity: .32; }

@media (prefers-color-scheme: dark) {
  :global([data-theme="system"]) .fur     { fill: #6e5f90; }
  :global([data-theme="system"]) .belly   { fill: #9e8fbe; }
  :global([data-theme="system"]) .feature { fill: #ede6ff; }
  :global([data-theme="system"]) .mouth   { stroke: #ede6ff; }
  :global([data-theme="system"]) .whisker { stroke: #ede6ff; opacity: .32; }
}
...
.otter-anim .wline-b {
  animation: inkflow 1.8s ease-in-out .5s infinite alternate;
}
@keyframes inkflow {
