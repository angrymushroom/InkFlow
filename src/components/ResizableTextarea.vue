...
const maxHeightCss = computed(() => (maxHeightPx.value != null ? `${maxHeightPx.value}px` : 'none'))
...
.resizable-textarea-handle {
  ...
  background:
    linear-gradient(135deg, transparent 45%, var(--border) 45%, var(--border) 52%, transparent 52%),
    linear-gradient(135deg, transparent 62%, var(--border) 62%, var(--border) 68%, transparent 68%),
    linear-gradient(135deg, transparent 78%, var(--border) 78%, var(--border) 84%, transparent 84%);
