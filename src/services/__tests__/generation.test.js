...
const { buildSceneContext, generateSceneProse, generateFromScene } =
  await import('@/services/generation.js')
...
describe('generation', () => {
  ...
  const scenes = [
    ...
    },
    {
      ...
      order: 1,
      title: 'Scene Two',
      oneSentenceSummary: 'The conflict.',
      notes: 'Use POV Alice.',
    },
  ]
